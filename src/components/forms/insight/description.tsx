    ...
    return (
        <div className='w-full bg-gray-00'>
            ...
            <div className='p-5 px-5 text-[14px]'>
                ...
                <textarea name="new" id="1" cols={1} rows={5} className='w-full min-h-[20px] overflow-y-hidden resize-y p-2 my-2 outline-none outline-solid outline-gray-300/90 outline-1 rounded-sm mb-5 placeholder:text-gray-400 bg-red-00' 
                ...
                <textarea name="new" id="1" cols={1} rows={2} className='w-full min-h-[20px] overflow-y-hidden resize-y p-2 my-2 outline-none outline-solid outline-gray-300/90 outline-1 rounded-sm mb-5 placeholder:text-gray-400 bg-red-00'
                placeholder='What is the aim of this initiative?'></textarea>
            </div>
        </div>
    )
}
