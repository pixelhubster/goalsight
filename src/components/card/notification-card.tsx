...
const NotificationCard = (props: {message: string, ok: boolean}) => {
    ...
    return (
        <div className="max-w-[25rem] fixed top-[8rem] left-[50%] z-[2] h-fit p-2 flex flex-col justfiy-center items-start m-auto translate-x-[-50%] translate-y-[-50%] bg-white rounded-md shadow-lg popup">
