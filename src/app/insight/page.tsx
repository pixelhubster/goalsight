      ...
      <div className='w-full h-full bg-red-300 p-2 flex xl:px-10'>
        ...
        <div className='w-full'>
          ...
          <div className='w-full bg-green-00 mt-2'>
            ...
            <p className='px-2 text-sm font-medium flex justify-start items-center'><div className='w-[5px] h-[5px] bg-green-500 animate-ping rounded-full mr-1'></div> Owner</p>
        ...
        <div className='w-[40rem] bg-green-400 max-lg:hidden ml-2'>
          <Statistics />
          <Ledger />
